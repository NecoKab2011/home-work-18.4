...
function openUpdateModal(id) {
    currentUpdateId = id;
    fetch(`${api}/${id}`).then((response)=>response.json()).then((student)=>{
...
async function submitUpdateStudent(e) {
    ...
    const updatedStudent = {
        ...
        skills: modalForm.elements["update-skills"].value.split(",").map((skill)=>skill.trim()),
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequireff0d", {})

//# sourceMappingURL=home-work-18.4.31b563d9.js.map
